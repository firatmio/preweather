...
const translations = {
  tr: {
    ...
    'app.coord.latlon': 'Enlem/Boylam',
    'app.coord.mgrs': 'Askeri (MGRS)',
    'app.coord.mgrsPlaceholder': 'MGRS koordinatı girin (örn: 35TMK1234567890)',
    'app.convert': 'Dönüştür',
    'app.mgrs.invalid': 'Geçersiz MGRS koordinatı',
    'app.mgrs.converted': 'MGRS koordinatı başarıyla dönüştürüldü',
    'app.lat': 'Enlem:',
    'app.lng': 'Boylam:',
    'app.date': 'Tarih',
  ...
  en: {
    ...
    'app.coord.latlon': 'Lat/Lng',
    'app.coord.mgrs': 'Military (MGRS)',
    'app.coord.mgrsPlaceholder': 'Enter MGRS coordinate (e.g: 35TMK1234567890)',
    'app.convert': 'Convert',
    'app.mgrs.invalid': 'Invalid MGRS coordinate',
    'app.mgrs.converted': 'MGRS coordinate successfully converted',
    'app.lat': 'Lat:',
    'app.lng': 'Lng:',
    'app.date': 'Date',

...
const translations = {
  tr: {
    ...
    'home.description': "NASA'nın güçlü API'leri ve Prophet makine öğrenimi modeliyle gelecek tarihlerde hava durumu tahminleri yapın. Sadece geçmiş verileri görmekle kalmayın, geleceği öngörün.",
    'home.cta.start': 'Tahmine Başla',
    'home.cta.how': 'Nasıl Çalışır?',
    
    'home.feature1.title': 'NASA API Gücü',
    'home.feature1.desc': "NASA'nın kapsamlı meteoroloji ve uydu verilerini kullanarak en doğru tahminleri üretin.",
    'home.feature2.title': 'Prophet ML Modeli',
    'home.feature2.desc': "Facebook'un geliştirdiği Prophet ile gelecek tarihler için güvenilir tahminler oluşturun.",
    'home.feature3.title': 'Gelecek Tahminleri',
    'home.feature3.desc': 'Sadece bugünü değil, gelecek haftaları ve ayları tahmin edin. Planlama yapın.',
    ...
    'home.cta.description': 'Tahminlerinizi yapmaya başlayın ve veriye dayalı kararlar alın.',
  ...
  'about.description': "PreWeather, NASA API'leri ve Prophet tahmin modeli ile gelecek tarihli hava durumu öngörüleri sunar.",
  'about.badge': 'PreWeather Misyonu',
  'about.mission.title': 'Misyonumuz',
  'about.mission.text': 'Geleceğin hava durumunu daha erişilebilir, anlaşılır ve tahmin edilebilir kılmak için NASA verisi + makine öğrenimi + öngörüsel modelleme bir arada.',
  'about.mission.data': 'Veri Kaynağı',
  'about.mission.data.desc': 'NASA uydu ve gözlem verileri ile bilimsel doğruluk.',
  'about.mission.ai': 'Tahmin Motoru',
  'about.mission.ai.desc': 'Prophet tabanlı zaman serisi modelleme ile ileri tarih öngörüleri.',
  'about.mission.accuracy': 'Tutarlılık',
  'about.mission.accuracy.desc': 'Model performansını ölçen sürekli validasyon ve geri besleme döngüsü.',
  'about.mission.scalable': 'Genişleyebilirlik',
  'about.mission.scalable.desc': 'Modüler API yapısı ile yeni veri kaynaklarını entegre etmeye hazır.',
  'about.roadmap.title': 'Yol Haritası',
  'about.roadmap.text': 'Ürünün evrimi: çekirdekten ileri analitik yeteneklere.',
  'about.roadmap.phase1': 'Çekirdek Altyapı',
  'about.roadmap.phase1.desc': 'NASA API entegrasyonu, temel tahmin pipeline, çok dilli arayüz.',
  'about.roadmap.phase2': 'Model İyileştirme',
  'about.roadmap.phase2.desc': 'Ek zaman serisi bileşenleri, mevsimsellik ince ayarı, hata analiz panelleri.',
  'about.roadmap.phase3': 'Gelişmiş Görselleştirme',
  'about.roadmap.phase3.desc': 'Harita tabanlı tahmin katmanı, anomaly highlight, interaktif senaryo.',
  'about.roadmap.phase4': 'Ekosistem & API',
  'about.roadmap.phase4.desc': 'Geliştirici API anahtarları, webhook desteği, entegrasyon kitleri.',
  'about.call.title': 'Geleceği Birlikte Tahmin Edelim',
  'about.call.text': 'PreWeather sürekli gelişiyor. Geri bildiriminiz, doğruluk ve kapsamın artmasına katkı sağlar.',
  'about.call.docs': 'Dokümantasyona Git',
  'about.call.try': 'Uygulamayı Deneyin',
    
    // Docs Page
    'docs.title': 'Dokümantasyon',
    'docs.description': 'API kullanımı ve özellikler hakkında detaylı bilgiler.',
  ...
  'app.select.desc': 'Haritaya tıklayarak bir konum seç. Ardından tarih belirleyip tahmin al.',
  ...
  'addr.invalidMessage': 'Geçerli bir kara adresi bulunamadı. Yeni bir nokta seçin veya adres arayın.',
  ...
  'unit.celsius': '°C',
  'unit.fahrenheit': '°F',
  'unit.toggleLabel': 'Sıcaklık Birimi',
  ...
  '404.home': 'Ana Sayfa',
  '404.app': 'Uygulama',
  '404.hint': "URL'yi kontrol edebilir veya yukarıdaki bağlantılardan devam edebilirsiniz.",
  'metric.ALLSKY_KT': 'Güneşlenme İndisi (ALLSKY_KT)',
  'metric.AOD_55_ADJ': 'Aerosol Optik Derinliği (AOD_55_ADJ)',
  'metric.CDD18_3': 'Soğutma Derece Gün (CDD18_3)',
  'metric.FROST_DAYS': 'Don Gün Sayısı (FROST_DAYS)',
  'metric.HDD18_3': 'Isıtma Derece Gün (HDD18_3)',
  ...
  'cookie.required.message': 'Devam edebilmek için temel işlevsellik sağlayan zorunlu çerezleri kabul etmeniz gerekiyor. Bu çerezler oturum ve dil tercihleri gibi çekirdek özellikler içindir ve pazarlama amacı taşımaz.',
  ...
  'cookie.required.info': 'Detaylı politika yakında eklenecek.',
    ...
    'cookie.message': 'Deneyiminizi geliştirmek için çerezleri kullanıyoruz. Siteyi kullanmaya devam ederek çerez kullanımını kabul etmiş olursunuz.',
  ...
  en: {
    ...
    'home.description': 'Make weather predictions for future dates with NASA\'s powerful APIs and Prophet machine learning model. Don\'t just see past data, predict the future.',
    'home.cta.start': 'Start Predicting',
    'home.cta.how': 'How It Works?',
    
    'home.feature1.title': 'NASA API Power',
    'home.feature1.desc': 'Generate the most accurate predictions using NASA\'s comprehensive meteorology and satellite data.',
    'home.feature2.title': 'Prophet ML Model',
    'home.feature2.desc': 'Create reliable predictions for future dates with Prophet developed by Facebook.',
    'home.feature3.title': 'Future Predictions',
    'home.feature3.desc': 'Predict not just today, but weeks and months ahead. Plan accordingly.',
    ...
    'home.cta.description': 'Start making your predictions and make data-driven decisions.',
  ...
  'about.description': 'PreWeather delivers future date weather forecasts using NASA data and the Prophet time series model.',
  'about.badge': 'PreWeather Mission',
  'about.mission.title': 'Our Mission',
  'about.mission.text': 'Unifying NASA data + machine learning + predictive modeling for accessible future weather intelligence.',
  'about.mission.data': 'Data Source',
  'about.mission.data.desc': 'Scientific fidelity powered by NASA satellite and observation data.',
  'about.mission.ai': 'Forecast Engine',
  'about.mission.ai.desc': 'Prophet-based time series modeling for forward-looking projections.',
  'about.mission.accuracy': 'Consistency',
  'about.mission.accuracy.desc': 'Continuous validation loop monitoring model performance.',
  'about.mission.scalable': 'Scalability',
  'about.mission.scalable.desc': 'Modular API design ready for new data source integrations.',
  'about.roadmap.title': 'Roadmap',
  'about.roadmap.text': 'Product evolution: from core to advanced analytical capabilities.',
  'about.roadmap.phase1': 'Core Infrastructure',
  'about.roadmap.phase1.desc': 'NASA API integration, base prediction pipeline, multilingual UI.',
  'about.roadmap.phase2': 'Model Refinement',
  'about.roadmap.phase2.desc': 'Additional time series factors, seasonal tuning, error dashboards.',
  'about.roadmap.phase3': 'Advanced Visualization',
  'about.roadmap.phase3.desc': 'Map-based forecast layer, anomaly highlighting, interactive scenarios.',
  'about.roadmap.phase4': 'Ecosystem & API',
  'about.roadmap.phase4.desc': 'Developer API keys, webhook support, integration kits.',
  'about.call.title': 'Let’s Predict the Future Together',
  'about.call.text': 'PreWeather is evolving. Your feedback helps improve accuracy and coverage.',
  ...
  'app.select.desc': 'Click on the map to choose a location. Then pick a date to get a forecast.',
  ...
  'app.result.summary.placeholder': 'Model prediction sample data (placeholder)',
  ...
  'addr.invalidMessage': 'No valid land address found. Pick another point or search an address.',
  ...
  'unit.celsius': '°C',
  'unit.fahrenheit': '°F',
  'unit.toggleLabel': 'Temperature Unit',
  ...
  '404.desc': 'The page you are looking for may have been moved, deleted, or never existed.',
  '404.home': 'Home',
  '404.app': 'App',
  ...
  'cookie.required.message': 'To continue, you must accept the essential cookies that enable core functionality (session, language preference). These do not include marketing or tracking cookies.',
  'cookie.required.accept': 'Accept Essential Cookies',
  'cookie.required.info': 'Detailed policy coming soon.',
    
    // Cookie Consent
    'cookie.title': 'We Use Cookies',
    'cookie.message': 'We use cookies to improve your experience. By continuing to use the site, you accept the use of cookies.',
